...
colors.get_colors = function()
  ...
  if vim.o.background == "dark" then
    mycolors = {
      ...
      -- vscGray = "#808080",
      -- vscViolet = "#6c71c4", -- magenta (bright) from TOML
      vscBlue = "#80cbc4", -- blue from TOML
      -- vscAccentBlue = "#4FC1FF",
      -- vscDarkBlue = "#223E55",
      vscMediumBlue = "#7dc6bf", -- blue (bright) from TOML
      -- vscDisabledBlue = "#729DB3",
      -- vscLightBlue = "#9CDCFE",
      -- vscGreen = "#c3e88d", -- green from TOML
      -- vscBlueGreen = "#4EC9B0",
      -- vscLightGreen = "#B5CEA8",
      -- vscRed = "#eb606b", -- red from TOML
      -- vscOrange = "#CE9178",
      -- vscLightRed = "#D16969",
      -- vscYellowOrange = "#D7BA7D",
      -- vscYellow = "#f7eb95", -- yellow from TOML
      -- vscDarkYellow = "#FFD602",
      -- vscPink = "#ff2f90", -- magenta from TOML
